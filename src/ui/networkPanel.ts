...
/**
 * Live diagram of the best car's [5,4,3,2] network, like UINeuralNetworkPanel:
...
export class NetworkPanel {
  ...
  /** Redraws at most 5 times per second. Genome layout: layer-major row-major, bias rows last. */
